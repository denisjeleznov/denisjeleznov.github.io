...
DDD рекомендует делить систему на "автономные контексты" - bounded context. Как правило, границы bounded context определяются границей бизнес-транзакции. Реализация бизнес-транзакции требует привлечения функционала со всех зон ответственности "слоистой" архитектуры.
