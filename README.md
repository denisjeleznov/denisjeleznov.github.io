...
Чтобы фреймворк смог вызывать код пользователя, последний должен "интегрироваться" в инфраструктуру фреймворка. Следовательно, пользовательский код сильнее связан с кодом фрейморка чем библиотеки.
