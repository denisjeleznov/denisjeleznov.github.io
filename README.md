...
Одна из задач, решаемых в ходе разработки архитектуры распределённой системы - выделение "автономных доменов" данных. Как правило, границы доменов определяются границами транзакций.
